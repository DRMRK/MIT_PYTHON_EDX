...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug  1 10:34:40 2020
...
receives a score, based on the length of the word and the letters in that 
word.
...
(4+1+4+3+1+1+1)*7=105, plus an additional 50 point bonus for using all 
n letters)."""
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    """
    letinhand=calculateHandlen(hand)
    score =0
    #print(letinhand)
    ...
    while letinhand >=0:
        ...
        # Otherwise (the input is not a single period):
            ...
            #updated total score, in one line followed by a blank line  
                ...
                score+=score1
                print(" %s earned %s points. Total: %s"%(word,score1,score))
                # Update the hand 
